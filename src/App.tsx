...
function App() {
  return (
    <Root>
      <Header
        sx={{ ...applyHeaderStyles({ fullWidth: true, height: "63px" }) }}
      >
      ...
      >
        <EdgeSidebarContent sx={{ containerType: "inline-size" }}>
          ...
          <Divider />
          <Box sx={{ minHeight: 0, overflow: "scroll" }}>
            {/* scrollable */}
          ...
          <ButtonBase
            ...
            sx={{ height: 48, flex: "none", fontSize: "1rem" }}
      ...
      >
        <EdgeSidebarContent>
          <Box sx={{ p: 2, display: "flex", alignItems: "center" }}>
            <Typography
              sx={{ fontSize: "1.25rem", fontWeight: "bold", flex: "auto" }}
            >
              Documentation
            </Typography>
            <IconButton
              onClick={(event) => {
                toggleEdgeSidebarRightCollapse({ event, state: true });
              }}
            >
              <CloseIcon />
            </IconButton>
        ...
        <Box sx={{ height: 2000 }}>
          <Container sx={{ py: 3 }}>
            ...
            <Button
              ...
              onClick={(event) => {
                toggleEdgeSidebarRightCollapse({ event, state: false });
              }}
            >
              Open documentation
            </Button>
      ...
      <Footer sx={{ minHeight: 400, p: 2 }}>Footer</Footer>
    </Root>
  );
}
